...
const wr = await fetch(`${ORG}/api/data/v9.2/webresourceset?$filter=startswith(name,'cc_vip.KustoExplorer')&$select=name,modifiedon,versionnumber`,{headers:H}).then(r=>r.json());
