...
const cc = await fetch(`${ORG}/api/data/v9.2/customcontrols?$filter=name eq 'vip_vip.KustoExplorer'&$select=name,version,customcontrolid`, { headers: H }).then(r=>r.json());
