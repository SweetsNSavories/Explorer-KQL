...
const wr = await fetch(`${ORG}/api/data/v9.2/webresourceset?$filter=name eq 'cc_vip.KustoExplorer/bundle.js'&$select=name,modifiedon,versionnumber`,{headers:H}).then(r=>r.json());
console.log(JSON.stringify(wr.value, null, 2));
console.log('current path id:', '000000030352138', '=', parseInt('000000030352138',10));
