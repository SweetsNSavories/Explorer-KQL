...
const r=await fetch(`${ORG}/api/data/v9.2/systemforms(69c22e59-1888-4d06-9afb-4d301a3a5d2f)?$select=name,formxml`,{headers:H});
const j=await r.json();
fs.writeFileSync('formxml.xml', j.formxml);
console.log(j.formxml);
