...
const pat=await fetch(`${ORG}/api/data/v9.2/solutions(60d1fecb-6c27-4757-9bed-70dcda4c5e94)`,{method:'PATCH',headers:H,body:JSON.stringify({version:'1.0.2.0',description:'Explorer-KQL: in-form Kusto/Application Insights query editor for Dynamics 365.'})});
...
const out='../dist/KustoExplorerSolution_1_0_2_managed.zip';
fs.mkdirSync('../dist',{recursive:true});
fs.writeFileSync(out, buf);
console.log('wrote', out, 'bytes:', buf.length);

// 5. Also unmanaged for source-control / dev import
...
if(ej2.ExportSolutionFile){
  ...
  fs.writeFileSync('../dist/KustoExplorerSolution_1_0_2_unmanaged.zip', buf2);
