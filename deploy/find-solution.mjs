...
const r=await fetch(`${ORG}/api/data/v9.2/solutions?$select=uniquename,friendlyname,version,ismanaged,solutionid&$filter=contains(uniquename,'Kusto') or contains(uniquename,'kusto') or contains(uniquename,'Explorer')`,{headers:H});
