...
// targeted publish for customcontrols + webresources + entity form
const xml = `<importexportxml><webresources><webresource>5751e760-533e-4e1e-966b-efcf186bb3d5</webresource><webresource>78c86be2-09f4-4889-9caf-2708ba29cb9e</webresource></webresources><customcontrols><customcontrol>d0ec2473-8fcb-4153-bed6-c73be0d0a2ed</customcontrol></customcontrols><entities><entity>systemuser</entity></entities></importexportxml>`;
const p = await fetch(`${ORG}/api/data/v9.2/PublishXml`,{method:'POST',headers:H,body:JSON.stringify({ParameterXml:xml})});
